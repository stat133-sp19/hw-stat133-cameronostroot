---
title: "warmup01-cameron-ostroot"
...
\[   d(\textbf{p},\textbf{q}) = d(\textbf{q},\textbf{p}) =  \sqrt{(q_{1}-p_{1})^2 + (q_{2}-p_{2})^2 + \cdot\cdot\cdot + (q_{n}-p_{n})^2} \]
...
\[ ||\textbf{p}|| =  \sqrt{p_{1}^2 + p_{2}^2 + \cdot\cdot\cdot + p_{n}^2} = \sqrt{\textbf{p} \cdot \textbf{p} }, \]
